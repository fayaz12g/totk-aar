...
'''
    ...
    visuals1_1_0= f'''// Fix the Rendering of Sky Islands When Using a Multiplier of {int(res_multiplier)}x
@{skyfix}
...
'''
    ...
    visuals1_1_1 = f'''// Fix the Rendering of Sky Islands When Using a Multiplier of {int(res_multiplier)}x
@{skyfix}
...
'''
    ...
    visuals1_1_2 = f'''// Fix the Rendering of Sky Islands When Using a Multiplier of {int(res_multiplier)}x
@{skyfix}
...
'''
    ...
    visuals1_2_0 = f'''// Fix the Rendering of Sky Islands When Using a Multiplier of {int(res_multiplier)}x
@{skyfix}
...
'''
    ...
    visual_fixes.append(visuals1_2_1)

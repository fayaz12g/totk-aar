...
00CEA5EC 2101221E'''
            visual_fixese = ""
            if do_disable_fxaa:
                visual_fixese += f"{fxaa_value} {fxaa_replace}\n"
            if do_DOF:
                visual_fixese += f"{DOF_value} {DOF_replace}\n"
            if do_disable_fsr:
                visual_fixese += f"{fsr_value} {FSR_replace}\n"
            if do_disable_reduction:
                visual_fixese += f"{reduction_value} {reduction_replace}\n"
            if do_disable_ansiotropic:
                visual_fixese += f"{ansiotropic_value} {ansiotropic_replace}\n"
            if do_disable_dynamicres:
                visual_fixese += f"{dynamic1_value} {dynamic1_replace}\n"
                visual_fixese += f"{dynamic2_value} {dynamic2_replace}\n"
            if do_force_trilinear:
                visual_fixese += f"{trilinear_value} {trilinear_replace}\n"
            if do_cutscene_fix:
            ...
            if shadow_quality > 0:
                visual_fixese += f"{shadow1_value} {shadow1_replace}\n"
...
0090E9C4 61008052'''
            ...
            visual_fixesa = ""
            if do_disable_fxaa:
                visual_fixesa += f"{fxaa_value} {fxaa_replace}\n"
            if do_DOF:
                visual_fixesa += f"{DOF_value} {DOF_replace}\n"
            if do_disable_fsr:
                visual_fixesa += f"{fsr_value} {FSR_replace}\n"
            if do_disable_reduction:
                visual_fixesa += f"{reduction_value} {reduction_replace}\n"
            if do_disable_ansiotropic:
                visual_fixesa += f"{ansiotropic_value} {ansiotropic_replace}\n"
            if do_disable_dynamicres:
                visual_fixesa += f"{dynamic1_value} {dynamic1_replace}\n"
                visual_fixesa += f"{dynamic2_value} {dynamic2_replace}\n"
            if do_force_trilinear:
                visual_fixesa += f"{trilinear_value} {trilinear_replace}\n"
            if do_cutscene_fix:
            ...
            if shadow_quality > 0:
                visual_fixesa += f"{shadow1_value} {shadow1_replace}\n"
...
0081FF44 61008052'''
            visual_fixesb = ""
            if do_disable_fxaa:
                visual_fixesb += f"{fxaa_value} {fxaa_replace}\n"
            if do_DOF:
                visual_fixesb += f"{DOF_value} {DOF_replace}\n"
            if do_disable_fsr:
                visual_fixesb += f"{fsr_value} {FSR_replace}\n"
            if do_disable_reduction:
                visual_fixesb += f"{reduction_value} {reduction_replace}\n"
            if do_disable_ansiotropic:
                visual_fixesb += f"{ansiotropic_value} {ansiotropic_replace}\n"
            if do_disable_dynamicres:
                visual_fixesb += f"{dynamic1_value} {dynamic1_replace}\n"
                visual_fixesb += f"{dynamic2_value} {dynamic2_replace}\n"
            if do_force_trilinear:
                visual_fixesb += f"{trilinear_value} {trilinear_replace}\n"
            if do_cutscene_fix:
            ...
            if shadow_quality > 0:
                visual_fixesb += f"{shadow1_value} {shadow1_replace}\n"
...
00C7758C C0035FD6'''
            visual_fixesc = ""
            if do_disable_fxaa:
                visual_fixesc += f"{fxaa_value} {fxaa_replace}\n"
            if do_DOF:
                visual_fixesc += f"{DOF_value} {DOF_replace}\n"
            if do_disable_fsr:
                visual_fixesc += f"{fsr_value} {FSR_replace}\n"
            if do_disable_reduction:
                visual_fixesc += f"{reduction_value} {reduction_replace}\n"
            if do_disable_ansiotropic:
                visual_fixesc += f"{ansiotropic_value} {ansiotropic_replace}\n"
            if do_disable_dynamicres:
                visual_fixesc += f"{dynamic1_value} {dynamic1_replace}\n"
                visual_fixesc += f"{dynamic2_value} {dynamic2_replace}\n"
            if do_force_trilinear:
                visual_fixesc += f"{trilinear_value} {trilinear_replace}\n"
            if do_cutscene_fix:
            ...
            if shadow_quality > 0:
                visual_fixesc += f"{shadow1_value} {shadow1_replace}\n"
...
00C7758C C0035FD6'''
            visual_fixesd = ""
            if do_disable_fxaa:
                visual_fixesd += f"{fxaa_value} {fxaa_replace}\n"
            if do_DOF:
                visual_fixesd += f"{DOF_value} {DOF_replace}\n"
            if do_disable_fsr:
                visual_fixesd += f"{fsr_value} {FSR_replace}\n"
            if do_disable_reduction:
                visual_fixesd += f"{reduction_value} {reduction_replace}\n"
            if do_disable_ansiotropic:
                visual_fixesd += f"{ansiotropic_value} {ansiotropic_replace}\n"
            if do_disable_dynamicres:
                visual_fixesd += f"{dynamic1_value} {dynamic1_replace}\n"
                visual_fixesd += f"{dynamic2_value} {dynamic2_replace}\n"
            if do_force_trilinear:
                visual_fixesd += f"{trilinear_value} {trilinear_replace}\n"
            if do_cutscene_fix:
            ...
            if shadow_quality > 0:
                visual_fixesd += f"{shadow1_value} {shadow1_replace}\n"

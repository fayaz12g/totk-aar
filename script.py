...
def patch_blarc(aspect_ratio, HUD_pos, unpacked_folder, expand_shutter):
    ...
    if aspect_ratio >= 16/9:
        ...
        patch_anim('PaDataFileBtn_00_PicLoad', 0, 1/s1) # new        
        ...
        patch_blyt('SystemSaveLoad_00', 'A_DayAndClear_00', 'shift_x', 20) # new
        patch_blyt('SystemSaveLoad_00', 'T_Place_00', 'shift_x', 20) # new

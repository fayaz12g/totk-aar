...
def patch_blarc(aspect_ratio, HUD_pos, unpacked_folder, expand_shutter2):
    ...
    if aspect_ratio >= 16/9:
        ...
        patch_blyt('SystemSaveLoad_00', 'N_Save_00', 'scale_x', s1) # new
        patch_blyt('SystemSaveLoad_00', 'W_CheckCover_00', 'scale_x', s1) # new
        patch_blyt('SystemSaveLoad_00', 'A_DayAndClear_00', 'scale_x', s1) # new
        patch_blyt('SystemSaveLoad_00', 'T_Place_00', 'scale_x', s1) # new
        patch_blyt('SystemSaveLoad_00', 'N_AutoSaveIcon_00', 'scale_x', s1) # new
        patch_blyt('SystemSaveLoad_00', 'N_PopupBase_00', 'scale_x', ((1/s1)*.759)) # new
